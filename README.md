...
3. getElementById return single element and getElementsByClassName return html collection

### Difference Between querySelector and querySelectorAll
1. querySelector returns the first matching element while querySelectorAll returns the all matching elements
2. querySelector returns a single element while querySelectorAll returns a node list
3. querySelector does not need a loop but querySelectorAll need a loop to access multiple elements.
